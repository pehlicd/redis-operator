...
# yazio.com/redis-operator-bundle:$VERSION and yazio.com/redis-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= yazio.com/redis-operator
...
IMG ?= pehli/redis-operator-controller
